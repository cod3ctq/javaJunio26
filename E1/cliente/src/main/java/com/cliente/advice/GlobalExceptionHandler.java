...
//Mecanismo del franework para manejar todas las excepciones (las propias definidas por el framework y ademas perponalizadas que nosotros hayamos: creado
// propagar con thow y thows
// try and catch( para recibir el pase)
@ControllerAdvice
