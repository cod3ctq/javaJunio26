...
public class ClienteRequest {
    ...
    private String correo; //VALIDACION DE NEGOCIO : NO REPETIR CORREO

    @NotBlank(message = "No puede estar en blanco o vacio")
    @Size(message = "Limite de caracteres superado", max = 18)
    private String ine; //VALIDACION DE NEGOCIO : NO REPETIR INE

    @NotBlank(message = "No puede estar en blanco o vacio")
    @Size(message = "Limite de caracteres superado", max = 13)
    private String rfc; // //VALIDACION DE NEGOCIO : NO REPETIR RFC

    @NotNull
    @Past(message= "La fecha no puede ser actual o a futuro")
    private LocalDate fechaNac; //VALIDACION DE NEGOCIO : QUE SEA MAYOR DE EDAD
