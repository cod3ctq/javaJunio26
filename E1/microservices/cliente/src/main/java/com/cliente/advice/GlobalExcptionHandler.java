...
import com.cliente.errors.ApiErros;
...
//controlador global de exceptions:
//Mecanismo del framework para manejar todas las excepciones
//y las propias definidas por el framework
//y demas las personalizadas que nosotros hayamos creado
@ControllerAdvice
public class GlobalExcptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleHttpRequestMethodNotSupported(HttpRequestMethodNotSupportedException ex, HttpHeaders headers, HttpStatusCode status, WebRequest request) {
        ...
        ApiErros errores = new ApiErros(ex.getMessage(), detalles, status, LocalDateTime.now());
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex, HttpHeaders headers, HttpStatusCode status, WebRequest request) {
        ...
        ApiErros errores = new ApiErros("Datos inválidos", errors, HttpStatusCode.valueOf(422), LocalDateTime.now());
    ...
    public ResponseEntity<Object> handleBusinessException(RuntimeException ex) {
        ApiErros errores = new ApiErros(ex.getMessage(), HttpStatusCode.valueOf(422), LocalDateTime.now());
        return ResponseEntity.status(HttpStatusCode.valueOf(422)).body(errores);
    }
    @ExceptionHandler(AlreadyExistExcption.class)
