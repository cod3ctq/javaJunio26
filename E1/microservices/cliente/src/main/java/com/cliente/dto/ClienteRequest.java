...
public class ClienteRequest {
    ...
    private String telefono;  //VALIDACION DE NEGOCIO NO REPETIR TELEFONO

    @NotBlank(message = "No puede estar en blanco o vacio")
    @Email(message = "Correo no Valido")
    private String correo; //VALIDACION DE NEGOCIO NO SE PUEDE REPETIR

    @NotBlank(message = "No puede estar en blanco o vacio")
    @Size(message = "Limite de caracteres superado", max = 18)
    private String ine;//VALIDACION DE NEGOCIO NO SE PUEDE REPETIR

    @NotBlank(message = "No puede estar en blanco o vacio")
    @Size(message = "Limite de caracteres superado", max = 13)
    private String rfc; //VALIDACION DE NEGOCIO NO SE PUEDE REPETIR

    @NotNull
    @Past(message= "La fecha no puede ser actual o a futuro")
    private LocalDate fechaNac;//VALIDACION DE NEGOCIO : QUE SE MAYOR DE EDAD
