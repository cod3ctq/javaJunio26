...
public class ClienteRequest {
    ...
    private String telefono;//VALIDACION DE NEGICIO: NO REPETIR TELEFONO

    @NotBlank(message = "No puede estar en blanco o vacio")
    @Email(message = "Correo no Valido")
    private String correo;//VALIDACION DE NEGICIO: NO REPETIR CORREO

    @NotBlank(message = "No puede estar en blanco o vacio")
    @Size(message = "Limite de caracteres superado", max = 18)
    private String ine;//VALIDACION DE NEGICIO: NO REPETIR INE

    @NotBlank(message = "No puede estar en blanco o vacio")
    @Size(message = "Limite de caracteres superado", max = 13)
    private String rfc;//VALIDACION DE NEGICIO: NO REPETIR RFC

    @NotNull
    @Past(message= "La fecha no puede ser actual o a futuro")
    private LocalDate fechaNac;////VALIDACION DE NEGICIO: QUE SEA MAYOR DE EDAD
