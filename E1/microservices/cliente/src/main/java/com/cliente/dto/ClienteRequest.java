...
public class ClienteRequest {
    ...
    @NotBlank(message = "No puede estar en blanco o vacio")
    @Size(message = "Limite de caracteres superado", max = 100)
    private String apM;//Validacio de negocio: nop

    @NotBlank(message = "No puede estar en blanco o vacio")
    @Size(message = "Limite de caracteres superado", max = 100)
    private String direccion;//validacion de negocios: No repetir RFC
    ...
    private String telefono;// validacion de negocio que sea mayor de edad
