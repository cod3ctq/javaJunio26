...
//    @PutMapping --> Se borro el metodo actualizar, debido a que por regla de negocio no es requerido actualizar los datos de un prestamo una vezque se ha concretado
//    public ResponseEntity<PrestamoResponse> actualizar(@RequestBody PrestamoRequest request){
//        PrestamoResponse prestamos = prestamo.actualizar(request);
//        return new ResponseEntity<PrestamoResponse>(prestamos, HttpStatusCode.valueOf(200));
//    }
