...
// @Service : Define qué componente resuelve la lógica de negocio
...
public class PrestamoLogic implements PrestamoService {
    ...
    public PrestamoResponse guardar(PrestamoRequest request) {
        ...
        int clienteId = http.getForObject("http://localhost:8090/api/v1/cliente/buscar-rfc/"+request.getRfc(),
                Integer.class);
