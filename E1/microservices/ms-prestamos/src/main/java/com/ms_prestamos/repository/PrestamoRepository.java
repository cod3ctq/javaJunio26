...
public interface PrestamoRepository extends JpaRepository<Prestamos,Integer> {
    ...
    @Transactional // Asegura la consistencia de la operacion, si falla, revierte automaticamente los cambios
    @Modifying // Le dice a JPA que es una actualización, no una lectura o insercion.
