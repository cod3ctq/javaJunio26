...
public interface PrestamoRepository extends JpaRepository<Prestamos,Integer> {
    ...
    //revierte automaticamente los canmbios
    @Modifying//L e dice a la JPA que es una actualizacion, no una lectura de inserccion
    ...
    Optional<List<Prestamos>> finAllActive();
