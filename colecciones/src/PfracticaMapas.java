...
public class PfracticaMapas {
    public static void main(String[] args) {

        //Map es una estructura que asocia llave :valor
        //Map vs HasMap
        ...
        System.out.println(registro.get("00001111ABD")); //Susana Gomez Flores
        //Eliminar un elemento mediante la llave
        registro.remove("00001113CDF");
        System.out.println("Elementos despues de la elliminacion : "+registro.size());


        //Elimina un elemento mediante solo si la llave esta asociada a ese valor
//        registro.remove("00001112ABC","Kelly Martinez Luna  19/10/2005 Tijuana");
        System.out.println("Elementos despues de la segunda elliminacion : "+registro.size());



        //borrar un valor del mapa

        //existe la llave ?
        System.out.println(registro.containsKey("00001130CDE"));

        //existe el valor ?
//        System.out.println(registro.containsValue("Martin Ortega Ruiz 08/10/1996 Mazatlan"));
...
//            System.out.println(registro.get(key));
            ...
            //imprimir las personas que su nombre termine con ez
...
//            }
                 ...
                 //Personas nacidas en el 2000 o despues
