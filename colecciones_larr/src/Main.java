...
public class Main {
    public static void main(String[] args) {
        ...
        // Listas.
        // List vs Arraylist : List es uuna interface; Arraylist es una clase.
        // Arraylist es un tipo especifico de lista, una clase que implemente la interface List.
        // PARAMETRIZABLE : Necesita que definas el tipo de dato de los objetos que almacenará.
        List<String> lista = new ArrayList<String>();

        List<Ciudad> ciudades = new ArrayList<Ciudad>(); // Lista de objetos personalizados

        // Añade elementos a la lista (.add()).
        ...
        ciudades.add(new Ciudad("Villa Allende","Veracruz",827882,"Pesca",351633,88734));
...
//        System.out.println(lista.get(6));
        ...
        // Eliminar un elemento en una posición especifica (por indice)
//        lista.remove(3);
        ciudades.remove(15);

        // Eliminar un elemento en una referencia (por referencia)
//        lista.remove("puebla");
        ciudades.remove(c16);
        ...
        // Devuelve la posición donde se encuentra el elemento por 1ra vez
//        System.out.println(lista.indexOf("Java"));
        System.out.println(ciudades.indexOf(c20));

        // Devuelve la posición donde se encuentra el elemento por ultima vez
...
//
//            // buscar las ciudades con una población >=850000
