...
public class PracticaMapas {
    public static void main(String[] args) {
        ...
        // Map es una estuctura de asociacion llave:valor
        // Map vs HashMap
        ...
        System.out.println("Elementos despues de la primera eliminación : "+registro.size());
...
//        registro.remove("00001112ABC", "Kelly Martinez Luna 19/10/2005 Tijuana");
        System.out.println("Elementos despues de la segunda eliminación : "+registro.size());

        // Existe la llave?
        System.out.println(registro.containsKey("00001144STU"));

        // Existe el valor?
//        System.out.println(registro.containsValue("Mauricio Salazar Luna 24/12/1994 Mexicali"));
...
//            System.out.println(p.getFechaNac().substring(6, p.getFechaNac().length()));
            // Imprimir las personas nacidas en el 2000 o después
