...
public class PracticaMapas {
    public static void main(String[] args) {
        ...
        //HashMap es una clase que implementa la interface map
        //   K         V
        ...
        registro.put("00001153TUV", new Persona("Alberto", "Navarro", "Diaz",
        ...
        System.out.println("Elementos despues e la primer elimincion:  "+registro.size());

        //eliminar un elemento mediante si la llave esta asociada a ese valor
        //registro.remove("00001112ABC","Kelly Martinez Luna 19/10/2005 Tijuana");
        System.out.println("Elementos despues de la segunda elimincion:  "+registro.size());

        //¿Existe la llave?
        System.out.println(registro.containsKey("00001147BCD"));
...
//
//            //Imprime el valor asociado a la llave actualmente itetadsa
//            //System.out.println(registro.get(key));
//
//            //Imprimir los personas que su apellido paterno termine con "ez"
//            // y su lugar de origen comeience con C
...
//        }
        ...
        ///Iterrar sobre el conjjunto de los valores
        for(Persona p:registro.values()) {
            ...
            //Imprimir los personas que su apellido paterno termine con "ez"
            // y su lugar de origen comeience con C
            if((registro.get(p).getApellidoPat().endsWith("ez")) && (registro.get(p).getLugarOrigen().startsWith("C"))){
                System.out.println(registro.get(p));
