...
public class Main {
    public static void main(String[] args) {
        ...
        //Parametrizable : Necesita que definas el tipo de dato de los objeto que almacenará
        ...
        ciudades.add(new Ciudad("Villa Allende", "Veracruz",
                827882, "Pesca",351633,88734));
