...
//arraylist> es una clase
        ...
        ciudades.add(new Ciudad("mexico","mexico edo",120,"indu",23.0,51));
        ...
        //obt6ener un elemento en una posicion especifica
        ...
        //devuelve la posicion donde wse encuentra el elemento por ultia vez
       ...
       // lista.clear();//vacia la lista
        ...
        for (int i =0; i<ciudades.size(); i++){
            c = ciudades.get(i);
            System.out.println(ciudades.get(i) + " :"+ ciudades.get(i).getActEco());

            //buscar las ciudades con una poblcion >= 85000
//            if (c.getHabitantes()>=85000){
