...
//a solo 1 garantizando y consistencia de datos
public class ConexionOracle {
    ...
    //Dentro se crea el inico objeto conecction que apunta directamente a la base
    private ConexionOracle(){
        try {
            Class.forName(driver);
            connection = DriverManager.getConnection(url,user,password);
            connection.setAutoCommit(true); //persiste los cambios INSERT update
