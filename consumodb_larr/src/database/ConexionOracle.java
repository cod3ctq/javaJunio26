...
// Patron SINGLETON : Limita la cantidad de objetos que se pueden hacer de una determinada clase a solo 1, garantizando
// el estado y consistencia de datos.
...
public class ConexionOracle {
    ...
    private ConexionOracle(){
        try{
            ...
            connection.setAutoCommit(true); // Persiste los cambios de sentencias INSERT, UPDATE, DELETE.
        }catch(Exception ex){
            ex.printStackTrace();
        }
    }
