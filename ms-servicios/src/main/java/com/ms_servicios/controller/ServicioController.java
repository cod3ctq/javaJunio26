...
public class ServicioController {
    ...
    // @RequestBody habilita la manipulación del cuerpo de la petición
    @PostMapping
    ...
    // @PathVariable : Permite extraer los valores pasados como variables en las url's
    ...
    // 6 : Se establecen las rutas (Endpoints) junto con los verbos de acción que le dicen al servidor qué accion ejecutar
